...
GetKey.MouseButton1Down:connect(function()
	setclipboard(https://direct-link.net/1128702/hyper-hub-key-aistem)
...
GuiRemoval.MouseButton1Down:connect(function()
	...
	game.StarterGui:SetCore("SendNotification", {Title = "1", Text = "2", Icon = "", Duration = 5})
end)
